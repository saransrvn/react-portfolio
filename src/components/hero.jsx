...
const Hero = ()=>{
  return(
   <section className='flex flex-col md:flex-row px-5 py-32 bg-gradient-to-r from-yellow-400 to-orange-500 justify-center'>
    <div className='mt-10 md:w-1/2 flex flex-col justify-center'>
    <h1 className='text-white text-6xl font-hero-font'>Saravanan <span className='text-black'>R,</span></h1>
    ...
    <div className='flex py-10'>
     <a href='https://www.linkedin.com/in/saravanan-ramachandran-74250a212' target='blank' className='pr-20 hover:text-white'><AiOutlineLinkedin size={35}/></a>
